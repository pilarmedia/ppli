...
*/
      ...
      //->middleware('permission:settingemail-index');
      ...
      //->middleware('permission:provinsi-index');
      Route::post('/provinsi', [provinsiController::class,'store']);
      //->middleware('permission:provinsi-add');
      Route::post('/provinsi/{id}', [provinsiController::class,'update']);
      //->middleware('permission:provinsi-edit');
      ...
      Route::get('/kontak/getmap/{id}',[kontakController::class,'getmap']);
